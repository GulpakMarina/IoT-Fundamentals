...
int melody[] = {
  NOTE_B4, NOTE_A4, NOTE_B4, NOTE_E4, 0, 
  NOTE_C5, NOTE_B4, NOTE_C5, NOTE_B4, NOTE_A4, 0, 
  NOTE_C5, NOTE_B4, NOTE_C5, NOTE_E4, 0, 
  NOTE_A4, NOTE_G4, NOTE_A4, NOTE_G4, NOTE_FS4, NOTE_A4, 0, 
  NOTE_G4, 0 
};
...
void playTone(int pin, int frequency, int duration, int vol) {
  ...
  long pulseWidth = (period * vol) / 255; 
